...
const USUARIOS_ACESSO_RANGE = 'USUARIOS_ACESSO!A1:F2000'
...
//   SHEET_ERROR    — falha ao consultar a planilha (rede, auth, aba inexistente, etc.)
export async function getUserFromSheet(email) {
  ...
  const idx = {
    ...
    status: col(['STATUS'], 2),
    perfil: col(['PERFIL'], 3),
    dataCadastro: col(['DATA_CADASTRO', 'DATA CADASTRO'], 4),
    ultimaAlteracao: col(['ULTIMA_ALTERACAO', 'ÚLTIMA_ALTERAÇÃO', 'ULTIMA ALTERACAO'], 5),
  }
